function sliderInit(container) {
  const slider = container.querySelector('.slider'),
        items = container.querySelector('.slider__slides'),
        prev = container.querySelector('.slider__control_prev'),
        next = container.querySelector('.slider__control_next');
  ...
  function generateDots() {
    const dots = container.querySelector('.js-slider__dots'),
  ...
  function dotActive() {
    const dotsCollection = container.querySelectorAll('.slider__dot');      
